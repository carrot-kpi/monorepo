...
export const MarkdownInput = ({
    ...
    const editor = useEditor(
        {
            ...
            editorProps: {
                attributes: {
                    class: "cui-prose cui-prose-base focus:cui-outline-none prose-p:cui-font-mono cui-h-full dark:cui-prose-invert prose-pre:dark:cui-bg-gray-700",
                },
            },
            onUpdate: ({ editor }) => {
    ...
    return (
        ...
        >
            ...
            <div className="prose-p:cui-font-mono"></div>
        </BaseInputWrapper>
    );
};
