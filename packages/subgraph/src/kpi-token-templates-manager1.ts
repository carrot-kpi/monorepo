...
import {
    ...
    KPITokensManager1 as KPITokensManager1Contract,
...
import { KPITokensManager } from "../generated/schema";
import { createTemplate, getTemplate } from "./commons";
import { cidToSpecification } from "./commons";

function getKPITokensManager1(address: Address): KPITokensManager {
