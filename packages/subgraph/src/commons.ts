...
import {
    ...
    ARBITRUM_SEPOLIA_KPI_TOKENS_MANAGER_ADDRESS,
    ARBITRUM_SEPOLIA_ORACLES_MANAGER_ADDRESS,
...
export function getFactoryAddress(): Bytes {
    ...
    if (network == "arbitrum-sepolia") return ARBITRUM_SEPOLIA_FACTORY_ADDRESS;
...
export function getKPITokensManagerAddress(): Bytes {
    ...
    if (network == "arbitrum-sepolia")
        return ARBITRUM_SEPOLIA_KPI_TOKENS_MANAGER_ADDRESS;
    throw new Error(
...
export function getOraclesManagerAddress(): Bytes {
    ...
    if (network == "arbitrum-sepolia")
        return ARBITRUM_SEPOLIA_ORACLES_MANAGER_ADDRESS;
    throw new Error(
