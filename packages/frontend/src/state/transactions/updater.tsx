...
import { useActiveWeb3React, updateBlockNumber, useBlockNumber } from '@carrot-kpi/react'
...
const RETRY_OPTIONS_BY_CHAIN_ID: Record<ChainId, RetryOptions> = {
...
export function TransactionsStateUpdater(): null {
  ...
  const getReceipt = useCallback(
    (hash: string) => {
      ...
      const retryOptions = RETRY_OPTIONS_BY_CHAIN_ID[chainId as ChainId]
      return retry(
        () =>
