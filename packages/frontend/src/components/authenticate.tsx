            ...
            <div className="h-fit flex flex-col gap-4 items-center p-8 max-w-lg rounded-xl border border-black dark:border-white bg-white dark:bg-black mx-4">
                {address ? (
                    <>
                        ...
                        <Typography
                            data-testid="welcome-to-carrot-title-text"
                            variant="xl"
                            weight="bold"
                        ...
                        <Typography
                            data-testid="authenticate-description-text"
                            className={{
                        ...
                        <div className="flex gap-4">
                            <Button
                                data-testid="authenticate-cancel-button"
                                variant="secondary"
                                size="small"
                                onClick={onCancel}
                            >
                            ...
                            <Button
                                data-testid="authenticate-sign-button"
                                size="small"
                                onClick={handleSign}
                                loading={loading}
                            >
